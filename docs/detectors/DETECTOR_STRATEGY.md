...
**The consumers do read that flag now (ADR-042).** `plausibility.py` holds the single
...
**The week index feeding all of this was audited and is correct (ADR-042):** 48 weeks,
