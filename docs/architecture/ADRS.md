...
Because the repair was good. ADR-024 built `_close_orphaned_streams` to close
...
repairs.** It only surfaced because ADR-065 started reporting "the previous run
...
- ADR-065's unclean-restart note becomes true rather than universal. Without
