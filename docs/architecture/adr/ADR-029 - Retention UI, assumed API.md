...
quoted below is [[ADR-026 - Tiered clip retention|ADR-026]]'s as it stood then: its 30–90d first/best-per-species
band was later replaced by the operator-set keep flag in [[ADR-061 - Operator keep flag|ADR-061]].
