"""Refinement records, and the three bookkeeping columns retention will need (ADR-045).
...
side effect of adding a column -- see ADR-045's "What this does not do".
...
revision: str = "0006_refinement"
down_revision: str | None = "0005_review_correction_names"
